...
public class AccountTypeDialog extends Dialog implements IListener {

    ArrayList<AccountTypeModel>accountTypeModels;
    RecyclerView recyclerView;
    AccountTypeAdapter adapter;
    IListener iListener;
    AppCompatEditText editTextAccountType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.list_account_type);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getContext(),1);
        recyclerView.setLayoutManager(layoutManager);
        editTextAccountType = findViewById(R.id.edit_text_account_type);
        openList();
        editTextAccountType.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public void openList() {
        adapter = new AccountTypeAdapter(getContext(),accountTypeModels,iListener);
