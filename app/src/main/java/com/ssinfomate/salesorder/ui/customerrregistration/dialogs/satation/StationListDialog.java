...
public class StationListDialog extends Dialog implements IListener {

    ArrayList<StationListModel>stationListModels;
    StationListAdapter adapter;
    RecyclerView recyclerView;
    IListener iListener;
    AppCompatEditText editTextStationName;

    public StationListDialog(@NonNull Context context, ArrayList<StationListModel> stationListModels, IListener iListener) {
        super(context);
        this.stationListModels = stationListModels;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.list_station_list_name);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getContext(),1);
        recyclerView.setLayoutManager(layoutManager);
        editTextStationName = findViewById(R.id.edit_text_station_list);
        openList();
    ...
    public void openList() {
        adapter = new StationListAdapter(getContext(),stationListModels,iListener);
