...
public class DiscountDialog extends Dialog implements IListener {

    ArrayList<DiscountModel> discountModels;
    RecyclerView recyclerView;
    DiscountAdapter adapter;
    IListener iListener;
    AppCompatEditText editTextDiscountType;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.list_discount_type);
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getContext(),1);
        recyclerView.setLayoutManager(layoutManager);
        editTextDiscountType = findViewById(R.id.edit_text_discount_type);
        openList();
        editTextDiscountType.addTextChangedListener(new TextWatcher() {
            @Override
    ...
    public void openList() {
        adapter = new DiscountAdapter(getContext(),discountModels,iListener);
